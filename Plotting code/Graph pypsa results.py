...
no_pgp = '/Users/Dominic/Desktop/fourteen_year_yes_normal_no_pgp.pickle'
pgp_above = '/Users/Dominic/Desktop/fourteen_year_above_storage_jackie_price_yes_normal_all_mw_e6.pickle'
...
print(batt_costs)
print(pgp_costs)
print(wind_costs[0]+solar_costs[0]+batt_costs[0]+pgp_costs[0])
print(wind_costs[1]+solar_costs[1]+batt_costs[1]+pgp_costs[1])
...
plt.xticks(ind, ('No PGP', 'PGP (Aboveground Storage)'))
y = ['Solar', 'Wind', 'Battery', 'PGP']
ax1.legend(y, loc="best",bbox_to_anchor=(1, 0.6),fontsize='12')
...
#plt.savefig('Oahu Optimized Renewable System Cost Hunter Cost.jpg', dpi = 300, bbox_inches='tight')
plt.show()
