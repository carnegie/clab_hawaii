...
bp = ax.boxplot(data)
ax.set_xticklabels(['1 day', '2 days', '3 days', '4 days', '5 days', '6 days', '7+ days'])
plt.title('Solar Droughts Per Year In Oahu')
plt.ylabel('Number of Solar Droughts Per Year')
