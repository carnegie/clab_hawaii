...
f = h5py.File('Hawaii_2016_100m.h5', 'r')
print(f.keys())
...
for i in list:
    ...
    data = f["windspeed_100m"][0:105408 , [i]]
    print(data)
    #print(data.shape)
    #print(data.size)
...
hourly_wind = np.array(hourly_wind).reshape(-1, 8784)
#print(hourly_wind)
#print(hourly_wind.shape)
...
path = "C:/Users/Dominic/Desktop/WIND Toolkit cfs with leap/2016"
os.chdir(path)
