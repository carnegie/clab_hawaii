...
# Set title
plt.title('Stored Energy During 2006 for\nBattery + Hydrogen Energy Storage System', fontsize='16')

ax.legend(['HES', 'Battery'], loc='upper left')
ax.grid(False)
...
ax.xaxis.set_major_locator(ticker.FixedLocator([0, 730, 1460, 2190, 2920, 3650, 4380, 5110, 5840, 6570, 7300, 8030]))
...
# Set title
plt.title('Stored Energy During 2006 for\nBattery-Only System', fontsize='34')

ax.legend(['Battery'], loc='upper left', fontsize=24)
ax.grid(False)
