...
ax.set_title('Decrease in Electricity Price with\nIncreased Lost Load Allowed\nOnly Solar and Battery\nNo HES', fontsize=18, pad=10)

plt.savefig('C:\\Users\\Dominic\\desktop\\Oahu Results\\lost load series no hes solar only price decrease.jpg', dpi = 300, bbox_inches='tight')
plt.show()
