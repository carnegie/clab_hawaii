...
pickle1noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/CONUS_smaller_area_reliability_2006_1hr_no_pgp_output.pickle'
pickle2noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/CONUS_smaller_area_reliability_2006_10hr_no_pgp_output.pickle'
pickle3noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/CONUS_smaller_area_reliability_2006_100hr_no_pgp_output.pickle'
pickle4noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/WECC_smaller_area_reliability_2006_1hr_no_pgp_output.pickle'
pickle5noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/WECC_smaller_area_reliability_2006_10hr_no_pgp_output.pickle'
pickle6noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/WECC_smaller_area_reliability_2006_100hr_no_pgp_output.pickle'
pickle7noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/CA_smaller_area_reliability_2006_1hr_no_pgp_output.pickle'
pickle8noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/CA_smaller_area_reliability_2006_10hr_no_pgp_output.pickle'
pickle9noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/CA_smaller_area_reliability_2006_100hr_no_pgp_output.pickle'
pickle10noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/oahu_smaller_area_reliability_2006_1hr_no_pgp_output.pickle'
pickle11noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/oahu_smaller_area_reliability_2006_10hr_no_pgp_output.pickle'
pickle12noHES = '/Users/Dominic/Desktop/13-6-23 Rerun/Figure S Something3 - Smaller Area Reliability/Lost load 1 10 100 series/Solar Only No HES/Outputs/oahu_smaller_area_reliability_2006_100hr_no_pgp_output.pickle'
...
'''
#Alter each list so that the values in each list are divided by the first value in the list
noHES_cost_CONUS = [i / noHES_cost_CONUS[0] for i in noHES_cost_CONUS]
...
'''
#Alter each list so that the values in each list are divided by the first value in the list
yesHES_cost_CONUS = [i / yesHES_cost_CONUS[0] for i in yesHES_cost_CONUS]
...
ax.set_ylabel('Cost of Electricity [$/kWh]', fontsize=16)
ax.set_title('Lost Load Effects on Electricity Price\nwith Decreasing Geographical Area\nSolar Only, No Wind', fontsize=18, pad=10)

plt.savefig('C:\\Users\\Dominic\\desktop\\Oahu Results\\lost load series no wind price comparison.jpg', dpi = 300, bbox_inches='tight')
plt.show()
