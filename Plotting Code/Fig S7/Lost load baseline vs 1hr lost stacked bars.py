'''This code will plot given values that I took from output files.
It will plot the change in system cost when 1hr per year of lost load is permitted'''
...
baseline14yrnohes ='/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure 3 - Optimized System Cost/Outputs/oahu_optimized_system_yes_normal_no_PGP_output.pickle'
baseline14yryeshes ='/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure 3 - Optimized System Cost/Outputs/oahu_optimized_system_yes_normal_w_PGP_output.pickle'

lostload1hr14yrnohes ='/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure S10 - Lost Load/Lost Load Improved 14yr/Outputs/improved_lost_load_14yr_no_pgp_output.pickle'
lostload1hr14yryeshes ='/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure S10 - Lost Load/Lost Load Improved 14yr/Outputs/improved_lost_load_14yr_yes_pgp_output.pickle'

#Add system components to the cost lists

list1=[baseline14yrnohes, lostload1hr14yrnohes]
...
list2=[baseline14yryeshes, lostload1hr14yryeshes]
...
'''
list3=[baseline2006nohes, lostload1hr2006nohes]
for pickles in list3:
    with open(pickles, 'rb') as f:
        data = pickle.load(f)
        component_results = data['component results']
        spending = component_results['Capital Expenditure [$]']
        ...
        wind_cost = (wind / 8760 / 1000) + opex_wind/1000
        solar_cost = (solar / 8760 / 1000)
        battery_cost = (battery / 8760 / 1000) + opex_battery/1000
        h2_storage_cost = 0
        electrolyzer_cost = 0
        fuelcell_cost = 0
...
list4=[baseline2006yeshes, lostload1hr2006yeshes]
for pickles in list4:
    with open(pickles, 'rb') as f:
        data = pickle.load(f)
        component_results = data['component results']
        spending = component_results['Capital Expenditure [$]']
        ...
        solar_cost = solar / 8760 / 1000
        battery_cost = (battery / 8760 / 1000) + opex_battery/1000
        h2_storage_cost = h2store / 8760 / 1000
        electrolyzer_cost = (electrolysis / 8760 / 1000) + opex_electrolysis /1000
        fuelcell_cost = (fuelcell / 8760 / 1000) + opex_fuelcell / 1000
...
ax.set_title('Cost Decrease with Lost Load', y=1.01)
...
plt.xticks(ind, ('No Lost Load,\nNo HES', '1 Hour of Lost\nLoad Per Year,\nNo HES','No Lost Load,\nYes HES', '1 Hour of Lost\nLoad Per Year,\nYes HES'), rotation=45)
...
#legend = plt.legend(reversed([p1, p2, p3]), reversed(y), loc="best", bbox_to_anchor=(1, 0.6), fontsize='16', edgecolor='black')
...
plt.savefig('C:\\Users\\covel\\OneDrive\\desktop\\Oahu Results\\14yr load stacked bar.jpg', dpi = 300, bbox_inches='tight')
plt.show()