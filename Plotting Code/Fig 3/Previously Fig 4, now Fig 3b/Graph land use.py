...
#Input Paths
no_pgp = '/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure 4 - Optimized System Capacity/Outputs/oahu_optimized_system_no_normal_no_PGP_output.pickle'
pgp_above = '/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure 4 - Optimized System Capacity/Outputs/oahu_optimized_system_no_normal_w_PGP_output.pickle'
...
#Create third category with all zero values so plot shape matches with fig 3, which has 3 categories
data1 = np.insert(data1, 2, 0)
data2 = np.insert(data2, 2, 0)
data3 = np.insert(data3, 2, 0)
data4 = np.insert(data4, 2, 0)
data5 = np.insert(data5, 2, 0)
data6 = np.insert(data6, 2, 0)

ind = ['Without PGP','With PGP','n']
width = 0.7
...
ax.set_title('Oahu Renewable Electricity\nSystem Land Use', y=1.015)
...
plt.xticks(ind, ('Wind, Solar,\nBattery Only', 'With Hydrogen\nEnergy Storage', 'n'))
...
plt.savefig('C:\\Users\\covel\\OneDrive\\desktop\\Oahu Results\\Oahu Renewable Energy System Land Use.jpg', dpi = 900, bbox_inches='tight')
plt.show()