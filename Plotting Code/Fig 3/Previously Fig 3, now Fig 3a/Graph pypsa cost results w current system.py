...
no_pgp = '/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure 3 - Optimized system cost/Outputs/oahu_optimized_system_yes_normal_no_PGP_output.pickle'
pgp_above = '/Users/covel/OneDrive/Desktop/13-6-23 Rerun/Figure 3 - Optimized system cost/Outputs/oahu_optimized_system_yes_normal_w_PGP_output.pickle'
...
current_cost = [0.24572+0.001745+0.003690+0.001260,0,0]
...
plt.xticks(ind, ('Today\'s\nSystem', 'Wind, Solar,\nBattery Only', 'With Hydrogen\nEnergy Storage'))
y = ['Today\'s System', 'Solar', 'Wind', 'Battery', 'H$_2$ Storage', 'Electrolyzer', 'Fuel Cell']
...
plt.savefig('C:\\Users\\covel\\OneDrive\\desktop\\Oahu Results\\Oahu Optimized Renewable System Cost.jpg', dpi = 900, bbox_inches='tight')
plt.show()
