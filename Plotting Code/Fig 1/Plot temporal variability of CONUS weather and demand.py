...
HI_wind = Path("/Users/Dominic/Desktop/wind_series_Shaner_unnormalized.csv")
HI_solar = Path("/Users/Dominic/Desktop/solar_series_Shaner_unnormalized.csv")
HI_demand = Path("/Users/Dominic/Desktop/demand_series_Shaner_unnormalized.csv")
...
ax1.set_ylabel('Power divided by\n13-year mean', fontsize = 26, color = 'black')
...
plt.tight_layout()
#
plt.savefig('C:\\Users\\Dominic\\desktop\\Oahu Results\\CONUS Resources.png', dpi=300, bbox_inches='tight')
plt.show()