...
list2 = [no_hes_25, no_hes_50, no_hes_75, no_hes_100]
for list in list2:
...
#Plot the values
x = [0, 25,50,75,100]
y = [sys_costs[0], sys_costs[1], sys_costs[2], sys_costs[3], sys_costs[4]]
print(y)
...
plt.savefig('C:\\Users\\covel\\OneDrive\\desktop\\Oahu Results\\Costs with constrained wind generation.png', dpi=300, bbox_inches='tight')
plt.show()