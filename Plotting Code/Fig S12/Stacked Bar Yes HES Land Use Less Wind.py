...
legend = plt.legend(reversed([p1, p2, p3, p4, p5, p6]), reversed(y), loc="best", bbox_to_anchor=(1, 0.73), fontsize='22', edgecolor='black')
...
plt.savefig('C:\\Users\\covel\\OneDrive\\desktop\\Oahu Results\\Dec wind amount yes HES.jpg', dpi = 600, bbox_inches='tight')
plt.show()
