...
ax.set_yticks([0.17, 0.18, 0.19, 0.2])
...
plt.savefig('C:\\Users\\covel\\OneDrive\\desktop\\Oahu Results\\Land use wind constraints v system cost yes hes.png', dpi=300, bbox_inches='tight')
plt.show()
