...
HI_wind_no_leap = Path("/Users/Dominic/Desktop/wind_series_Shaner_unnormalized - 2006 onward - no leap.csv")
HI_solar_no_leap = Path("/Users/Dominic/Desktop/solar_series_Shaner_unnormalized - 2006 onward - no leap.csv")
...
plt.margins(x=0.01)
plt.savefig(os.path.join(output_path, 'Shaner CONUS Standard Deviation of Wind and Solar cfs.jpg'), dpi=300, bbox_inches='tight')
plt.show()