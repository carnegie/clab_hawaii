...
with open(pgp_above, 'rb') as f:
    ...
    electrolysis_dispatch = electrolysis_dispatch[815:959]
    fuelcell_dispatch = time_results['fuel_cell dispatch']
    fuelcell_dispatch = fuelcell_dispatch[815:959]
...
electrolysis_dispatch.index = range(1,145)
fuelcell_dispatch.index = range(1,145)
...
legend = plt.legend(reversed([p1, p2, p3, p6, p7]), reversed(y),bbox_to_anchor=(1.62, 0.75), fontsize='28', edgecolor='black')

for handle in legend.legendHandles:
    handle.set_edgecolor('black')
'''
# Display the plot
plt.savefig('C:\\Users\\Dominic\\desktop\\Oahu Results\\2006_02_04solar_drought_dispatch_curves.png', dpi=300, bbox_inches='tight')
plt.show()
